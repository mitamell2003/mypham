                            ...
                            <div class="form-add-product">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="a-n">
                                        ...
                                        <input type="text" id="name-product" name="name-product" value="<?php echo $data[0]["name"]?>" required>
                                    </div>
                                    <div class="a-d">
                                    ...
                                    <div class="a-c">
                                        ...
                                        <?php require_once __DIR__ . "/../../app/models/menuModel.php";
                                            ...
                                            <option value="<?php echo $row["id"] ?>"<?php if((int)$row["id"] === (int)$data[0]["category_id"]) echo "selected" ?>><?php echo $row["name"] ?></option>
